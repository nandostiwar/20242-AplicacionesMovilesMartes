import './styles/ChangePassword.css'; // Archivo CSS específico para el formulario de cambio de contraseña
...
function ChangePassword() {
    ...
    return (
        <div className="container">
            ...
            <button id="btnCambiar" onClick={handleChangePassword}>Cambiar Contraseña</button>
            <button id="btnHome" onClick={() => navigate('/')}>Inicio</button>
        </div>
    );
}
